...
import { GithubIcon, LinkedinIcon, TwitterIcon, InstagramIcon, YoutubeIcon, SlackIcon, MailIcon, ArrowRightIcon, CalendarIcon, BookOpenIcon, UserIcon, CodeIcon, HeartIcon } from 'lucide-react';

const Footer = () => {
  // Expanded team members data (15 contributors)
  const teamMembers = [
    { id: 1, name: 'Vaibhav Kothari', role: 'Developer', contribution: 'Architecture & Backend', image: 'https://avatars.githubusercontent.com/u/129139486?s=400&u=2ba574b1b840c3083f52c3bc166952fdb4f38e89&v=4' },
    { id: 2, name: 'Shubh Gupta', role: 'UX Designer', contribution: 'User Interface & Branding', image: '/api/placeholder/400/400' },
    { id: 3, name: 'Kartik Gupta', role: 'Frontend Developer', contribution: 'React Components & Animations', image: '/api/placeholder/400/400' },
    { id: 4, name: 'Shantanu Kumar', role: 'Content Strategist', contribution: 'Copywriting & SEO', image: '/api/placeholder/400/400' },
    { id: 5, name: 'Vishu prapt', role: 'Backend Developer', contribution: 'API Integration & Database', image: '/api/placeholder/400/400' },
    { id: 6, name: 'Avi Srivastava', role: 'Frontend Developer', contribution: 'Responsive Design & Accessibility', image: '/api/placeholder/400/400' },
    { id: 7, name: 'Amam ', role: 'DevOps Engineer', contribution: 'Deployment & Performance', image: '/api/placeholder/400/400' },
    { id: 8, name: 'Maya Patel', role: 'QA Specialist', contribution: 'Testing & Quality Assurance', image: '/api/placeholder/400/400' },
    { id: 9, name: 'David Kim', role: 'UI Developer', contribution: 'Component Library & Theming', image: '/api/placeholder/400/400' },
    { id: 10, name: 'Priya Sharma', role: 'Project Manager', contribution: 'Coordination & Planning', image: '/api/placeholder/400/400' },
    { id: 11, name: 'Raj Patel', role: 'Data Engineer', contribution: 'Analytics & Performance Metrics', image: '/api/placeholder/400/400' },
    { id: 12, name: 'Sophia Garcia', role: 'UI/UX Designer', contribution: 'Design System & Prototyping', image: '/api/placeholder/400/400' },
    { id: 13, name: 'Amir Hassan', role: 'Mobile Developer', contribution: 'Progressive Web App Features', image: '/api/placeholder/400/400' },
    { id: 14, name: 'Olivia Wilson', role: 'Technical Writer', contribution: 'Documentation & Tutorials', image: '/api/placeholder/400/400' },
    { id: 15, name: 'Liam Chen', role: 'Security Specialist', contribution: 'Authentication & Data Protection', image: '/api/placeholder/400/400' },
  ];
  ...
  const socialLinks = [
    ...
    { name: 'Mail', url: 'mailto:fullstackbu@bennett.edu.in', icon: <MailIcon className="w-5 h-5" /> },
  ];

  // Extended quick links for footer navigation
  const quickLinks = [
    { name: 'About Us', url: '/about', icon: <UserIcon className="w-4 h-4" /> },
    { name: 'Events', url: '/events', icon: <CalendarIcon className="w-4 h-4" /> },
    { name: 'Membership', url: '/join', icon: <UserIcon className="w-4 h-4" /> },
    { name: 'Resources', url: '/resources', icon: <BookOpenIcon className="w-4 h-4" /> },
    { name: 'Blog', url: '/blog', icon: <CodeIcon className="w-4 h-4" /> },
    { name: 'Contact', url: '/contact', icon: <MailIcon className="w-4 h-4" /> },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-12">
          <div className="flex items-center justify-center gap-3 mb-8">
            ...
            <h3 className="text-2xl font-semibold text-center">Our Amazing Contributors</h3>
          </div>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4" role="list" aria-label="Website Contributors">
              ...
              >
                <div className="relative mb-3">
                  <img
                    ...
                    className="w-16 h-16 rounded-full object-cover border-2 border-white border-opacity-50 group-hover:border-opacity-100 transition-all duration-300"
                    loading="lazy"
                  />
